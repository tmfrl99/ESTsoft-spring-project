...
public class ArticleResponse {
	...
	public ArticleResponse(Article article) {
		...
		this.createdAt = article.getCreatedAt() == null ? article.getCreatedAt() : LocalDateTime.parse("");
		this.updatedAt = article.getUpdatedAt() == null ? article.getUpdatedAt() : LocalDateTime.parse("");
	}
